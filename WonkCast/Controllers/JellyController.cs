...
namespace WonkCast.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class JellyController : ControllerBase
    {
        ...
        [ApiKey(ApiKeyName = "apiKey", ApiKeysRoute = "Services:WonkCast:Tokens")]
        ...
        private async Task<IActionResult> ProcessJellyPhrase(JellyPhrase phrase, string controllerName)
        {
            ...
            List<Media> queueItems = await JellyfinService.GetItems(phrase, userId);
